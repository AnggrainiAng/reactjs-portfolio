        ...
        <section className="px-10">
          ...
          <div className="text-center mx-10">
            ...
            <p className="text-md dark:text-white mb-8">
              Lorem Ipsum 只是印刷和排版行业的虚拟文本。 自 1500 年代以来，Lorem
              Ipsum
              一直是行业的标准虚拟文本，当时一位不知名的印刷商采用了一个打字机，然后乱打了一串字，做成了一本打字样本书。
              它不仅经历了五个世纪，而且经历了电子排版的飞跃，基本保持不变。
              它在 1960 年代随着包含 Lorem Ipsum 段落的 Letraset
              表的发布而流行起来，最近还随着 Aldus PageMaker
              等桌面出版软件（包括 Lorem Ipsum 的版本）而普及。
            </p>
          </div>
          <Projects />
        </section>
